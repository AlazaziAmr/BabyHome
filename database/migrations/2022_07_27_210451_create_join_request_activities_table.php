...
class CreateJoinRequestActivitiesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('join_request_activities', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('join_request_activities');
    }
}
