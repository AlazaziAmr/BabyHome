...
@section('content')
                ...
                <div class="card-header pb-0">
                    <div class="d-flex align-items-center">
                        ...
                        <button onclick="$('#create-model').modal('show')"
                           class="btn btn-primary btn-sm ms-auto">{{ __('site.create').' '.__('site.one_users') }}</button>
    ...
    @endcan
    @include('dashboard.users.users.create_model')
    @include('dashboard.users.users.edit_model')
