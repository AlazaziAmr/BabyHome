<div id="nursery" class="container tab-pane active"><br>
        ...
        <div class="col-md-6">
            ...
            <span class="font-weight-bold">
                ...
                @lang('site.name'):
                    ...
                    {{ $data['nursery']->owner ? $data['nursery']->owner->name : ''  }}</li>
                ...
                <li class="list-group-item border-0 ps-0 text-sm ">
                    ...
                    &nbsp; {{ $data['nursery']->owner ? $data['nursery']->owner->phone : ''  }}</li>
                ...
                <li class="list-group-item border-0 ps-0 text-sm ">
                    ...
                    &nbsp; {{ $data['nursery']->owner ? $data['nursery']->owner->email : ''  }}</li>
            ...
            <span class="font-weight-bold">
               <svg xmlns="http://www.w3.org/2000/svg" width="14px" height="14px" viewBox="0 0 24 24" fill="none"
                ...
                <li class="list-group-item border-0 ps-0 text-sm ">
                    ...
                    &nbsp; {{ $data['babysitter']->date_of_birth }} </li>
    ...
    <div class="row mt-2">
        ...
        @foreach($data['qualifications'] as $q)
            <div class="col-md-6">
                <li>{{ ($q->qualification) ? $q->qualification->name : '' }}</li>
                <p>{{ $q->description }}</p>
            </div>
        @endforeach
    </div>
