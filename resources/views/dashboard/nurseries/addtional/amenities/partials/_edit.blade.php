...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            <label for="is_required_edit_input">@lang('site.is_required')</label>
            <input {{ $form_data->is_required ? 'checked' : '' }} type="checkbox" name="is_required" id="is_required_edit_input" value="1">
        </div>
    </div>
</div>
