    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                <div class="logo-area">
                    <a href="{{ route(env('DASH_URL').'.index') }}"><img  width="80px" src="{{ asset('public/logo.jpg') }}" alt="" /></a>
                </div>
            </div>
                            ...
                            <div role="menu" class="dropdown-menu message-dd notification-dd animated zoomIn">
                                ...
                                <div class="hd-message-info">
                                    @foreach($settings['orders'] as $order)
                                        <a href="{{ route(env('DASH_URL').'.orders.show',$order->id) }}">
                        ...
                        <li class="nav-item"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><span><i class="notika-icon notika-support"></i></span><div class="spinner4 spinner-4"></div><div class="ntd-ctn"><span>{{ $settings['orders']->count() }}</span></div></a>
                            <div role="menu" class="dropdown-menu message-dd task-dd animated zoomIn">
                                <div class="hd-message-info hd-task-info">
                                    <a href="{{ route(env('DASH_URL').'.profile') }}">
                                        <div class="hd-message-sn">
                                            <div class="hd-mg-ctn">
                                    ...
                                    <a href="{{ route(env('DASH_URL').'.profile.password') }}">
                                        <div class="hd-message-sn">
                                            <div class="hd-mg-ctn">
