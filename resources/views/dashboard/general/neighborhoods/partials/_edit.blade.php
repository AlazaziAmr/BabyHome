...
<div class="row mg-tb-30">
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <div class="nk-int-mk sl-dp-mn">
            <label for="city_id_edit_input">@lang('site.city_id')</label>
        </div>
        <div class="bootstrap-select fm-cmp-mg">
            <select id="city_id_edit_input" name="city_id" class="form-control">
            ...
            <span class="help-block" id="city_id_edit_error"></span>
        </div>
    </div>
</div>
